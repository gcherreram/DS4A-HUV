...
# Create Layout
app.layout = html.Div((
    html.H1('Dashboard - Hospital Universitario del Valle',
    ...
    dcc.Slider(min=0,max=1,marks={0:'Microorganisms', 1:'Microorganisms Family', 2:'Antibiotics'}, value=0, id='fig-slider',)
)

@app.callback(Output('microorganisms-figure', 'figure'), [Input('fig-slider', 'value')])
